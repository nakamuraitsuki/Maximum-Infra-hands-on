...
import (
	...
	mock_message "example.com/infrahandson/test/mocks/usecase/message"
...
func TestGetMessageHistoryInRoom(t *testing.T) {
	...
	e := echo.New()
	mockUseCase := mock_message.NewMockMessageUseCaseInterface(ctrl)
	...
	mockResponse := messagecase.GetMessageHistoryInRoomResponse{
